\section{Related Works} \label{sec:42-research02-related}
\subsection{Foundations of Knowledge Transfer} \label{ch4:ssec:02-related-kd}
\begin{foldable} % Knowledge distillation
    The pioneering idea in knowledge transfer between neural networks, intuitively, was to train a student to mimic the teacher's outputs~\cite{bucila2006}.
    ...
    These soft labels act as essential \textit{inter-class} hints, conveying the hidden relationships that define an expert's logic.
    While foundational research has expanded these mechanisms, they generally assume a transparent environment where agents have full access to both original training data and the teacher model~\cite{romero2015, nguyen2021knowledge}.
\end{foldable}

\subsection{Constraints in Data Availability} \label{ch4:ssec:02-related-dfkd}
...
\subsection{Navigating Restricted Expert Interfaces} \label{ch4:ssec:02-related-bbdfkd}
