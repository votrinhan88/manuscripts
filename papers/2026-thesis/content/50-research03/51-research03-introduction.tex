...
\begin{foldable} % Our method TAKE and contributions
    ...
    The remainder of this paper is organised as follows: \S~\ref{sec:52-research03-related} reviews related work; \S~\ref{sec:53-research03-theory} presents theoretical motivation; \S~\ref{sec:54-research03-methodology} details TAKE and our DD pipeline; \S~\ref{sec:55-research03-experiments} reports experiments and discussion; \S~\ref{sec:56-research03-limitations} reflects limitations and ethical concerns; \S~\ref{sec:57-research03-conclusion} concludes.
\end{foldable}
