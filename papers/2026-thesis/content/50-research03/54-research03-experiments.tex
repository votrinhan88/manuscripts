...
\begin{foldable} % Baselines
  ...
  \begin{itemize}
    ...
    \item \textbf{DiLM}~\cite{maekawa2024dilm}: \ac{LLM}-generated candidates selected by gradient matching across k-centre selection. It evaluated on both classification and \ac{NLI}.
...
\begin{foldable} % Datasets and models
  We evaluate on two linguistic tasks: AG News~\cite{zhang2015character}, IMDb~\cite{maas2011learning}, SST-2 for classification; MNLI-m, QQP, and QNLI for~\ac{NLI}.
...
\begin{foldable} % NLI
  \textbf{The \ac{NLI} ceiling gap and what it implies.}
...
\begin{foldable} % Kernels
  Table~\ref{tab:results-abla-kernels} ablates the choice of temporal kernel defined in \S\ref{sec:53-research03-method-gradient-knowledge}.
