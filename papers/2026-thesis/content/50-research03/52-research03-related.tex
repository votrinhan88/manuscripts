\section{Related Work} \label{sec:52-research03-related}

\subsection{Text Dataset Distillation} \label{ch5:sec:02-related-textdd}
...
\begin{table}[t] % Table: Comparison of text DD methods.
    ...
    \label{ch5:tab:comparision-textdd-methods}
...
\begin{foldable} % TAKE is first to clear all three criteria
    Table~\ref{ch5:tab:comparision-textdd-methods} summarises the landscape.
...
\subsection{Influence Functions and the Hard-Sample Bias} \label{ch5:sec:02-related-influence}
...
\subsection{Optimal Transport for Distribution Matching} \label{ch5:sec:02-related-ot}
