\begin{abstract} \label{sec:00-abstract}
  ...
  We introduce \textbf{Trajectory-Aware Knowledge Estimation} (\textbf{TAKE}), which convolves the knowledge-based influence along the training trajectory into a single per-sample knowledge score, capturing informative samples.
  ...
  We release our source code at \url{https://github.com/votrinhan88/take}.

  \textbf{Keywords:} Text dataset distillation $\cdot$ Influence functions $\cdot$ Optimal transport.
\end{abstract}
