...
\begin{foldable} % Implementation details
    ...
    TAKE uses $T{=}20$ checkpoints, exponential kernel with $\lambda^* = T/T_m$~(\S\ref{sec:04-method-gradient}), Sinkhorn $\varepsilon{=}0.05$ / 200 iterations, and a Gemma-3-270M synthetic pool of $|\mathcal{D}_\text{synth}|{=}5{,}000$ samples.
\end{foldable}
